    ...
    render: function() {
        ...
        <Modal {...this.props}>
          <div className="modal-body">
            <p>
              Are you sure you want to delete <strong>{this.props.milestoneName}</strong> and all
              its items? This operation cannot be undone.
            </p>
          </div>
            ...
            <header className="panel-heading clearfix">
              ...
              <div className="pull-right">
                <div className="mu-button-wrapper">
                  ...
                  <ModalTrigger modal={<MilestoneFormModal {...this.state} onModalSubmit={this.handleUpdate} title={'Edit" '  + this.state.name + '"'} submitText="Save" submitStyle="success" />}>
                  ...
                  <div className="mu-milestone-progress col-sm-6">
                    ...
                    <div className="mu-milestone-progress-bar">
                      <div className="progress">
                        <div className="progress-bar progress-bar-success" role="progressbar" aria-valuenow="63" aria-valuemin="0" aria-valuemax="100" style={{width: this.state.progress + '%'}}>
