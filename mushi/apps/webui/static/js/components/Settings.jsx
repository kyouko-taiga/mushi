...
var PasswordForm = React.createClass({
    render: function() {
        ...
        <form className="form-horizontal" onSubmit={this.handleSubmit}>
          ...
          <Input type="password" ref="password" label="New password" labelClassName="col-sm-2" wrapperClassName="col-sm-10" placeholder="Enter new password" />
          <Input type="password" ref="confirm" label="Confirm new password" labelClassName="col-sm-2" wrapperClassName="col-sm-10" placeholder="Confirm new password" />
        </form>
        );
    }
});
